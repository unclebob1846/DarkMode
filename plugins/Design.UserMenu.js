...
window[window.dID][window.dID+"a"]("addUserMenuItemElement", function(name) {
	if (this.config.loggedIn)
	{
		var liElement = $('<li><a href><i style="font-size:23px;padding:0px 16px 0px 7px;line-height:1;" class="icon fa fa-'+this.config.Design.UserMenu.buttons[name].icon+'"></i><span style="line-height:4px;">'+name+'</span></a></li>');
